        ...
        <div class="rs-section-body">
            ...
            <div class="flex flex-wrap justify-center items-center mt-24">
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mb-4 lg:mb-0">
                    ...
                    <span class="text-uppercase text-xl text-black block">Established In</span>
                ...
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mb-4 lg:mb-0">
                    ...
                    <span class="text-uppercase text-xl text-black block">Annual Growth of</span>
                    <span class="text-uppercase text-4xl text-orange font-avenir block">377%</span>
                </div>
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mb-4 lg:mb-0">
                    <div class="rs-about-icon">
