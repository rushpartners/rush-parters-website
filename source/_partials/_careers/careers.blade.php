...
<div id="investor" class="rs-section rs-section-light px-8 md:px-0">
    <div class="container mx-auto text-center">
        ...
        <div class="rs-section-body">
            ...
            <div class="rs-section-title mt-24">
                Our Values
            </div>

            <div class="flex flex-wrap justify-center items-center">
                <div class="m-4 sm:w-1/3 md:w-1/3 lg:w-1/4 mb-4 lg:mb-0">
                    <span class="text-uppercase text-xl text-black block text-orange font-avenir">
                        Courage
                    </span>
                    <span class="text-black block">
                        Our team will be bold in their decision making and brave in the face of challenges that are presented to them</span>
                </div>
                <div class="m-4 sm:w-1/3 md:w-1/3 lg:w-1/4 mb-4 lg:mb-0">
                    <span class="text-uppercase text-xl text-black block text-orange font-avenir">
                        Loyalty
            ...
            <a class="btn-cta mt-24" href="https://form.jotform.com/201333477258355" target="_blank">
                Apply now
            </a>
        </div>
    </div>
